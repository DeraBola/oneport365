      ...
      <section className="customers_container">
        <div className="shipments_container">
          ...
          <div className="shipments_bottom">
            ...
            <li className="document-text" onClick={() => setActive("FirstCard")} ></li>
            <li className="document-text" onClick={() => setActive("SecondCard")} ></li>
            <li className="document-text" onClick={() => setActive("ThirdCard")} ></li>
            <li className="document-text" onClick={() => setActive("FourthCard")} ></li>
              <button ></button>
              <button>Cargo Detials </button>
