      ...
      <section className="customers_container">
        <div className="shipments_container">
          ...
          <div className="shipments_bottom">
            ...
            <li className="document-text" onClick={() => setActive("FirstCard")} >Documents</li>
            <li className="document-text" onClick={() => setActive("SecondCard")} >Cargo Detials </li>
            <li className="document-text" onClick={() => setActive("ThirdCard")} >Cargo Detials </li>
            <li className="document-text" onClick={() => setActive("FourthCard")} >Cargo Detials </li>
              <button ></button>
              <button></button>
