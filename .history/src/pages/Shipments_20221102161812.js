            ...
            <div className="shipments_middle">
              ...
              <div className="shipment_middle_two">
                <div className="shipment_middle_two_port">
                  ...
                  <div className="destination_port"> <p>{singleShipment.destination_port_code}</p></div>
                  <p>{singleShipment.destination_port_city}</p>,<p>{singleShipment.destination_port_country},</p>
                </div>
                <div className="shipment_middle_two_img"></div>
                <div className="shipment_middle_two_delivery "></div>
              </div>
            </div>
          )}
