...
import Services  from "../pages/Services";RatesDocument
      ...
      <section className="customers_container">
        <div className="shipments_container">
          ...
          <div className="shipments_bottom">
           ...
           {active === "FirstCard" && <UploadDocument />}
           {active === "SecondCard " && <Cargo />}
           {active === "ThirdCard " && <Services />}
           {active === "FourthCard " && <RatesDocument />}
          </div>
        </div>
      </section>
    </>
