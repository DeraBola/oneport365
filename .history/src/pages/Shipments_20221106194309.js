      ...
      <section className="customers_container">
        <div className="shipments_container">
          ...
          <div className="shipments_bottom">
            ...
            <li className="document-text" onClick={() => setActive("SecondCard")} >
            <div className="shipments_bottom_nav">
                          <span> Cargo Detials</span>
                          </div>
               </li>
            <li className="document-text" onClick={() => setActive("ThirdCard")} >
            <div className="shipments_bottom_nav">
                          <span>Additional Services </span>
                          </div>
               </li>
            <li className="document-text" onClick={() => setActive("FourthCard")} >
            <div className="shipments_bottom_nav">
                          <span>  Rates  </span>
                          </div>
            </li>
