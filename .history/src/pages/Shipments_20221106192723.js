        ...
        <div className="shipments_container">
          ...
          <div className="shipments_bottom">
            <nav>
              ...
              <button onClick={() => setActive("FirstCard")}>Cargo Detials </button>
              <button onClick={() => setActive("FirstCard")}>Additional Services</button>
              <button onClick={() => setActive("FirstCard")}>Rates</button>
            </nav>
          <UploadDocument />
          </div>
        </div>
